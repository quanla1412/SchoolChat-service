...
namespace SchoolChat.Service.Migrations
{
    ...
    [Migration("20241206155332_UserOnlineStatusLastSeen")]
    partial class UserOnlineStatusLastSeen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolChat.Service.Models.ChatRoomUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SchoolChat.Service.Models.DeleteMessageUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SchoolChat.Service.Models.TaskAssignee", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SchoolChat.Service.Models.UserTask", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SchoolChat.Service.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolChat.Service.Models.ChatRoomUser", b =>
                {
                    b.HasOne("SchoolChat.Service.Models.ChatRoom", null)
                        .WithMany("Users")
